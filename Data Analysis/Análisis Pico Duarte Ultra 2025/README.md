...
- Ver los tiempos de los participantes y cómo se distribuyen por distancia.

- Analizar los resultados según el género de los corredores.

- Explorar otras métricas de interés, como percentiles, comparaciones de ritmo, y más.

- Interactuar con filtros y slicers para enfocarte en distintos grupos o distancias.
